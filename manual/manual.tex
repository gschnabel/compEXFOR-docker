...
If Docker is installed, you should see information about the installed Docker version and you can proceed to the next section.
 ...
 If you want to enable authentication to access the computational EXFOR database to be created, open the file \path{install_all.sh} present in this folder in a text editor. At the beginning of this file are the two lines
\begin{verbatim}
  db_user=""
  db_password=""
\end{verbatim}
